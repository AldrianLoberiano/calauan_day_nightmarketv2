...
import { X, User, Phone, Building2, MapPin, Loader2, Info, ShieldCheck } from 'lucide-react';
...
function FormField({
  ...
  return (
    <div>
      ...
      {error && <p className="text-red-500 text-xs mt-1 flex items-center gap-1">Error: {error}</p>}
    </div>
  );
}
