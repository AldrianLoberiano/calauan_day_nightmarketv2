            ...
            <div style={{ position:'relative', zIndex:2, padding:'12px 14px' }}>
              ...
              <div style={{ display:'flex', gap:0, marginBottom:2 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  <CL t="C"/>
                  <div style={{ display:'flex', gap:-10, marginRight:6, marginTop:-6, alignItems:'flex-end', transform:'rotate(-38deg)', transformOrigin:'right bottom' }}>
                    {cC.map((s, idx) => {
                      const t = idx - (cC.length - 1) / 2;
                      const angle = -t * -20.5;
                      const offsetY = 2 + (t * t) *3.8;
                      const offsetX = 0;
                      return (
                        <div
                          key={s.id}
              ...
              <div style={{ display:'flex', gap:0 }}>
                ...
                {/* Left paired columns */}
                <div style={{ flexShrink:0, marginRight:3, display:'flex', flexDirection:'column', gap:0 }}>
