            ...
            <div style={{ position:'relative', zIndex:2, padding:'12px 14px' }}>
              ...
              <div style={{ display:'flex', gap:0, marginBottom:2 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  <div style={{ display:'flex', gap:-10, marginRight:-25, marginTop:-13, alignItems:'flex-end', transform:'rotate(-38deg)', transformOrigin:'right bottom' }}>
                    {cC.map((s, idx) => {
                      const t = idx - (cC.length - 1) / 2;
                      const angle = -t * -15;
                      const offsetY = -12 + (t * t) * 3;
                      const offsetX = -15;
                      return (
                        <div
                          key={s.id}
