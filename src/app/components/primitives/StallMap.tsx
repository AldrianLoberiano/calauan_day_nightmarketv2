            ...
            <div style={{ position:'relative', zIndex:2, padding:'12px 14px' }}>
              ...
              <div style={{ display:'flex', gap:0, marginBottom:2, position:'relative', zIndex:5 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  <div style={{ display:'flex', gap:-10, marginRight:-18, marginTop:-13, alignItems:'flex-end', transform:'rotate(-38deg)', transformOrigin:'right bottom', position:'relative', zIndex:10 }}>
                    {cC.map((s, idx) => {
                      const t = idx - (cC.length - 1) / 2;
                      const offsetY = -16 + (t * t) * 3;
                      const offsetX = -15;
                      return (
                        <div
                          key={s.id}
              ...
              <div style={{ display:'flex', gap:0, position:'relative' }}>
                ...
                {/* Left paired columns */}
                <div style={{ flexShrink:0, marginLeft:0, marginRight:3, marginTop:30, display:'flex', flexDirection:'column', gap:0, position:'relative' }}>
              ...
              <div style={{ display:'flex', gap:0, marginTop:-130, marginBottom:2, position:'relative' }}>
                <div style={{ width:52, flexShrink:0 }}/>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  ...
                  <div style={{ display:'flex', gap:0, marginLeft:2, marginRight:0, marginTop:-290, alignItems:'flex-end', transform:'rotate(130deg)', transformOrigin:'left bottom', position:'relative', zIndex:8 }}>
                    {cA.map((s, idx) => {
                      const t = idx - (cA.length - 1) / 2;
                      const offsetY = -130 + (t * t) * 4;  
                      const offsetX = -20;
                      return (
                        <div
                          key={s.id}
                          style={{
                            transform:`translate(${offsetX}px, ${offsetY}px) rotate(${t * 10}deg)`,
