        ...
        <div style={{ transform:`scale(${zoom})`, transformOrigin:'top left', minWidth:1750,
          ...
          <div style={{ position:'relative', border:'3px solid #1a1a6e' }}>
            ...
            <div style={{ position:'relative', zIndex:2, padding:'12px 14px' }}>
              ...
              {/* MARKET SITE */}
              <div style={{ position:'relative', display:'flex', justifyContent:'flex-start', gap:20, marginBottom:8, width:'100%', paddingLeft:170 }}>
              ...
              <div style={{ display:'flex', gap:0 }}>
                ...
                {/* Left paired columns */}
                <div style={{ flexShrink:0, marginRight:3, marginTop:50, display:'flex', flexDirection:'column', gap:0 }}>
                ...
                {/* PET BOTTLING */}
                <div style={{ width:220, height:160, flexShrink:0, marginLeft:8, marginTop:350, position:'relative', alignSelf:'flex-start' }}>
              ...
              <div style={{ display:'flex', gap:0, marginTop:2, marginBottom:2 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  <CL t="B"/>
                  <div style={{ display:'flex', gap:-10, marginRight:6, marginTop:-280, alignItems:'flex-end', transform:'rotate(-120deg)', transformOrigin:'right bottom' }}>
                    {[...cB].reverse().map((s, idx) => {
                      const t = idx - (cB.length - 1) / 2;
                      const angle = -t * -15;
                      const offsetY = -90 + (t * t) * 3;
                      const offsetX = 0;
                      return (
                        <div
                          key={s.id}
                  ...
                  <div style={{ display:'flex', gap:0, marginLeft:6, marginRight:50, marginTop:-250, alignItems:'flex-end', transform:'rotate(110deg)', transformOrigin:'left bottom' }}>
                    {cA.map((s, idx) => {
                      const t = idx - (cA.length - 1) / 2;
                      const angle = t * 17;
                      const offsetY = -40 + (t * t) * 3.8;  
                      const offsetX = 0;
                      return (
                        <div
                          key={s.id}
