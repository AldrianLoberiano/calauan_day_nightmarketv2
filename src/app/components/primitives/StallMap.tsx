            ...
            <div style={{ position:'relative', zIndex:2, padding:'12px 14px' }}>
              ...
              <div style={{ display:'flex', gap:0, marginTop:2, marginBottom:2 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:2, flex:1 }}>
                  ...
                  <div style={{ display:'flex', gap:0, marginLeft:6, marginRight:6, alignItems:'flex-end', transform:'rotate(90deg)', transformOrigin:'left bottom' }}>
                    {cA.map((s, idx) => {
                      const t = idx - (cA.length - 1) / 2;
                      const angle = t * 25;
                      const offsetY = -20 + (t * t) * 4.8;
                      const offsetX = 0;
                      return (
                        <div
                          key={s.id}
