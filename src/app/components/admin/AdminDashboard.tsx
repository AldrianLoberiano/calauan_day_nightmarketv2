    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-xs hidden sm:block">Pwesto Reservation Mapping System</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex gap-1 rounded-full bg-white/10 p-1 w-fit border border-white/15 backdrop-blur-md">
            {tabs.map(tab => (
              <button
                key={tab.id}
