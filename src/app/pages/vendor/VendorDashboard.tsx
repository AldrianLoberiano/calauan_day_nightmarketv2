  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-purple-200 text-xs hidden sm:block font-medium">Vendor Portal</p>
            </div>
          </div>
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 py-6 space-y-6">
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-800 rounded-2xl p-5 sm:p-6 text-white relative overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-xl sm:text-2xl font-black">Welcome, {vendor.fullName}</h2>
            <p className="text-purple-100 text-sm mt-0.5">View and manage your stall reservations</p>
            {vendor.businessName && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[11px] font-bold text-emerald-500 uppercase tracking-wider">Occupied</p>
            </div>
        ...
        <div className="flex items-center justify-between">
          <a
            href="/"
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-purple-600 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors"
          >
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
              ...
              <a
                href="/"
                className="inline-flex items-center gap-2 mt-4 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold rounded-xl transition-colors"
              >
                Browse Stalls
