    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/15 ring-1 ring-white/30 rounded-xl flex items-center justify-center">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <h1 className="font-black text-lg sm:text-xl leading-tight">Pwesto Reservation System</h1>
                <p className="text-slate-200/80 text-xs sm:text-sm">Public Market — Night Market Stall Mapping</p>
              </div>
            </div>
          ...
          {/* Stats bar */}
          <div className="flex flex-wrap gap-2 sm:gap-4 mt-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 px-3 py-3">
            ...
            <div className="ml-auto text-white/80 text-xs self-center hidden sm:block">
      ...
      <div className="bg-slate-100/80 border-b border-slate-200/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
          <div className="flex items-start sm:items-center gap-2 text-sm text-slate-700">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* Interactive Map */}
        <div className="bg-white rounded-2xl border border-slate-200/70 shadow-lg shadow-slate-200/60 overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
                />
              </div>
